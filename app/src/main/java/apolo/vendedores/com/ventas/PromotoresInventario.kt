...
class PromotoresInventario : AppCompatActivity() {
    ...
    private fun realizarVenta(){
        ...
        InventarioVencimiento.codVendedor = lista[posicion]["COD_VENDEDOR"].toString()
        InventarioVencimiento.codEmpresa = lista[posicion]["COD_EMPRESA"].toString()
        startActivity(Intent(this, InventarioVencimiento::class.java))
